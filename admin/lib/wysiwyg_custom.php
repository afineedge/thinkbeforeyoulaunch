...
function initWysiwyg($fieldname, $uploadBrowserCallback) {
  ...
  tinyMCE.init({
    ...
    theme_advanced_buttons1 : "formatselect,fontsizeselect,bold,italic,underline,|,justifyleft,justifyright,|,bullist,numlist,|,outdent,indent,|,sub,sup,charmap,|,removeformat,fullscreen",
