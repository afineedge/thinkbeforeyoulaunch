...
function showUpgradeErrors() {
  ...
  if (preg_match("/tinymce3/", $customWysiwygCode) || preg_match("/['\"]3rdParty/", $customWysiwygCode)) {
    $upgradeErrors .= "<b>Upgrade Notice</b>: WYSIWYG paths have changed.  Please compare your custom /lib/wysiwyg_custom.php file with the original /lib/wysiwyg.php and update any paths that have changed<br/>\n";
  }
