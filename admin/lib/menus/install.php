...
<form method="post" action="?" class="setAttr-spellcheck-false" autocomplete="off">
    ...
    <div class="tab-content default-tab">
      ...
      <table border="0" cellpadding="0" cellspacing="2" style="margin-left: 25px; width: 100%">
        ...
        <tr>
          ...
          <td><input name="mysqlPassword" value="<?php echo htmlencode(@$_REQUEST['mysqlPassword']) ?>" size="40" class="text-input medium-input" type="password" autocomplete="off"/><?php // security: disable autocomplete so sensitive info won't be stored in browser ?></td></td>
        </tr>
        <tr>
          ...
          <div class="tab-content <?php echo $tab1class ?>" id="tab1"> <!-- This is the target div. id must match the href of this div's tab -->
            ...
            For new installations please select an administrator username and password and write them down in a safe place.<br /><br />
             ...
             <tr>
              ...
              <td><input class="text-input medium-input" type="password" name="adminPassword1" value="<?php echo htmlencode(@$_REQUEST['adminPassword1']) ?>" size="40" autocomplete="off"/><?php // security: disable autocomplete so sensitive info won't be stored in browser ?></td></td>
             </tr>
             <tr>
              <td>Admin Password (again)&nbsp;</td>
              <td><input class="text-input medium-input" type="password" name="adminPassword2" value="<?php echo htmlencode(@$_REQUEST['adminPassword2']) ?>" size="40" autocomplete="off"/><?php // security: disable autocomplete so sensitive info won't be stored in browser ?></td></td>
