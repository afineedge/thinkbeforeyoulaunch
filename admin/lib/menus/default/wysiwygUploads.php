...
<html xmlns="http://www.w3.org/1999/xhtml">
 <head>
  ...
  <script src="<?php echo CMS_ASSETS_URL ?>/3rdParty/tiny_mce/tiny_mce_popup.js"></script>
  <script src="<?php echo CMS_ASSETS_URL ?>/3rdParty/tiny_mce/utils/mctabs.js"></script>
  <script src="<?php echo CMS_ASSETS_URL ?>/3rdParty/tiny_mce/utils/form_utils.js"></script>
  <link rel="stylesheet" type="text/css" href="<?php echo CMS_ASSETS_URL ?>/3rdParty/tiny_mce/themes/advanced/skins/default/dialog.css" />
  <style type="text/css">
    .photobox {
