...
<script type="text/javascript" src="<?php echo CMS_ASSETS_URL ?>/3rdParty/jqueryPlugins/thickbox.js"></script>
<script type="text/javascript" src="lib/menus/default/view_functions.js?<?php echo filemtime(SCRIPT_DIR.'/lib/menus/default/view_functions.js'); // on file change browsers should no longer use cached versions ?>"></script>
...
<form method="post" action="?" onsubmit="tinyMCE.triggerSave();" <?php disableAutocomplete(); ?>>
