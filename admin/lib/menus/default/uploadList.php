...
<html xmlns="http://www.w3.org/1999/xhtml">
 <head>
  ...
  <script src="//code.jquery.com/ui/1.10.4/jquery-ui.js"></script><?php /* for datepicker and jquery sortable */ ?><script>window.jQuery.ui || document.write('<script src="<?php echo CMS_ASSETS_URL ?>/3rdParty/jquery-ui-1.10.4.min.js"><\/script>')</script>
...
//--></script>
<script type="text/javascript" src="lib/admin_functions.js?<?php echo filemtime(SCRIPT_DIR.'/lib/admin_functions.js'); // on file change browsers should no longer use cached versions ?>"></script>
<script type="text/javascript" src="lib/menus/default/uploadList_functions.js?<?php echo filemtime(SCRIPT_DIR.'/lib/menus/default/uploadList_functions.js'); // don't cache changed files ?>"></script>
</form>
</body>
</html>
