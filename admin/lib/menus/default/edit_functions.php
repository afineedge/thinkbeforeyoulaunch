...
function _showTextfield($fieldSchema, $record) {
  ...
  print <<<__HTML__
   <tr>
    ...
    <td>
      <span>$prefixText<!-- --></span><input type="$inputType" name="$fieldname" value="$encodedValue" size="20" $maxLengthAttr class="text-input" style="width: $styleWidth" $readOnly $autoComplete/>
