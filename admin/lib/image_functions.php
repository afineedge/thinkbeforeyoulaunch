...
function saveResampledImageAs($targetPath, $sourcePath, $maxWidth, $maxHeight) {
  ...
  _fastimagecopyresampled($targetImage, $sourceImage, 0, 0, 0, 0, $targetWidth, $targetHeight, $sourceWidth, $sourceHeight, $imageType, $quality) || die("There was an error resizing the uploaded image!");
