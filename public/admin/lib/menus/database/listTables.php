...
<script type="text/javascript" src="lib/menus/database/listTables_functions.js?<?php echo filemtime(SCRIPT_DIR.'/lib/menus/database/listTables_functions.js'); // on file change browsers should no longer use cached versions ?>"></script>
