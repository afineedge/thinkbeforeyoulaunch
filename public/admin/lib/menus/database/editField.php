...
<html xmlns="http://www.w3.org/1999/xhtml">
 <head>
  ...
  <!-- javascript -->
  <script src="//code.jquery.com/jquery-1.11.0.min.js"></script><script>window.jQuery || document.write('<script src="<?php echo CMS_ASSETS_URL ?>/3rdParty/jquery-1.11.0.min.js"><\/script>')</script>
  <script src="//code.jquery.com/jquery-migrate-1.2.1.min.js"></script><script>jQuery.migrateWarnings || document.write('<script src="<?php echo CMS_ASSETS_URL ?>/3rdParty/jquery-migrate-1.2.1.min.js"><\/script>')</script>
  <script><!--
  ...
  <div style="display: none" class="fieldOption advancedUploadDir"><br/>
    ...
    <table border="0" cellspacing="0" cellpadding="0">
      ...
      <tr class="customUploadRow" style="display: <?php echo $customUploadRowDisplay ?>">
        ...
        <td>
          <input class="text-input" type="text" name="customUploadDir" id="customUploadDir" value="<?php echo htmlencode(@$field['customUploadDir']) ?>" size="50" onkeyup="updateUploadPathPreviews('dir', this.value, 1)" onchange="updateUploadPathPreviews('dir', this.value, 1)" /><br/>
          <small>
      ...
      <tr class="customUploadRow" style="display: <?php echo $customUploadRowDisplay ?>">
        <td>Folder Url</td>
        <td>
          <input class="text-input" type="text" name="customUploadUrl" id="customUploadUrl" value="<?php echo htmlencode(@$field['customUploadUrl']) ?>" size="50" onkeyup="updateUploadPathPreviews('url', this.value, 1)" onchange="updateUploadPathPreviews('url', this.value, 1)" /><br/>
          <small>
...
<script src="lib/menus/database/editField_functions.js?<?php echo filemtime(SCRIPT_DIR.'/lib/menus/database/editField_functions.js'); // on file change browsers should no longer use cached versions ?>"></script>
