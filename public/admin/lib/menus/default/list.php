...
<form method="get" name="preview" action="<?php echo PREFIX_URL ?><?php echo @$schema['_listPage'] ?>" target="_blank" autocomplete="off">
</form>
...
<script type="text/javascript" src="lib/menus/default/list_functions.js?<?php echo filemtime(SCRIPT_DIR.'/lib/menus/default/list_functions.js'); // on file change browsers should no longer use cached versions ?>"></script>
