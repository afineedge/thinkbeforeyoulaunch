<?php
/**
 * $Id: GoogleSpell.php,v 1.3 2015/03/23 22:18:21 dave Exp $
 *
...
class GoogleSpell extends SpellChecker {
  ...
  function &getSuggestions($lang, $word) {
    ...
    if (count($matches) > 0)
      ...
      // Fix from: http://www.tinymce.com/develop/bugtracker_view.php?id=4700
      // Google already returns responses as UTF8
  ...
  protected function _unhtmlentities($string) {
    // NOTE: This use of preg_replace_eval only uses sanitized results from _getMatches that: "remove everything but a-z or -" and "remove all control characters"
